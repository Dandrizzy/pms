  ...
  return (
    ...
    ">
      ...
      <form className=' text-neutral-900 min-h-screen grid gap-4' ref={form} onSubmit={sendEmail}>
        ...
        <div className="">
          <button disabled={disable} type='submit' className=' bg-indigo-600 py-2 text-neutral-100 rounded-full px-4 hover:bg-indigo-500 font-bold flex items-center gap-2 disabled:cursor-not-allowed disabled:bg-neutral-600 '>
