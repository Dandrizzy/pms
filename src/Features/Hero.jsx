                  ...
                  <Form onSubmit={handleSubmit(submit)}>
                    <div className="relative mt-2 rounded-md shadow-sm">
                      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <span className="text-gray-500 sm:text-sm"><BiMapPin className=' text-2xl ' /></span>
                      </div>
                      <input
                        required
                        ...
                        id="trackingCode"
                        className="block w-[24rem] md:w-[30rem] px-10 rounded-md text-2xl border-0 py-1.5 pl-10 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
