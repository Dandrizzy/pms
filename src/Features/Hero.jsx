                  ...
                  <Form onSubmit={handleSubmit(submit)}>
                    <div className="relative mt-2 rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        id="trackingCode"
                        className="block w-[28rem] px-10 rounded-md text-2xl border-0 py-1.5 pl-10 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
